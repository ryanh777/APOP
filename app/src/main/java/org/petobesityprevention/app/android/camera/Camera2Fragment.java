...
public class Camera2Fragment extends Fragment
    ...
    private Integer STATE_CAMERA = 1;
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    alertIV.setImageBitmap(rotatedBitmap);
                    alertPic.setView(view);
                    alertPic.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (id.equals("123")) {
                                ...
                                if (STATE_CAMERA == 1) {
                                    mImageView1.setImageBitmap(rotatedBitmap);
                                    mInstructText.setText("Take picture from the front");
                                } else if (STATE_CAMERA == 2) {
                                    mImageView2.setImageBitmap(rotatedBitmap);
                                    mInstructText.setText("Take picture from the top");
                                } else if (STATE_CAMERA == 3) {
                                    Intent resultIntent = new Intent();

                                    File outputDir = getContext().getCacheDir();
                                    File imageFile1 = new File(outputDir, "image1.jpg");
                                    ...
                                    try {
                                        ...
                                        bitmapDrawable1.getBitmap().compress(Bitmap.CompressFormat.JPEG, 100, os);
                                        os.flush();
                                        os = new FileOutputStream(imageFile2);
                                        bitmapDrawable2.getBitmap().compress(Bitmap.CompressFormat.JPEG, 100, os);
                                        os.flush();
                                        os = new FileOutputStream(imageFile3);
                                    ...
                                    resultIntent.putExtra("path1", imageFile1.getAbsolutePath());
...
//                                resultIntent.putExtra("byteArray3", bs3.toByteArray());
                                ...
                                File outputDir = getContext().getCacheDir();
                                File imageFile = new File(outputDir, "image.jpg");
...
//                                resultIntent.putExtra("byteArray3", bs3.toByteArray());
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mImageView1 = view.findViewById(R.id.imageview_1);
        mImageView2 = view.findViewById(R.id.imageview_2);
        mInstructText = view.findViewById(R.id.instruct_text);
        String id = getActivity().getIntent().getStringExtra("ID");
        if (id.equals("2")) {
            mInstructText.setText("Take picture from the front");
        } else if (id.equals("3")) {
...
//        String code = getActivity().getIntent().getExtras().getString("ID");
//        Integer bob = Integer.parseInt(code);
